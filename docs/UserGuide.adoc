...
Creates a new contact and sets the name to John Does, email address to john_d888@gmail.com, address to 207 Upper Street, Islington, LONDON, N1 1RL,
...
<replace the index in the second constraint with just INDEX>
****
