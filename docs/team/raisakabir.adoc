...
* Rewrote large parts of the User Guide to enhance it (Pull Request ).
* Reviewed and edited the language and structure of all documentation (Pull Requests ).
* Generated SampleData.xml file (Pull Request ).
* Set up organization, Milestones (until V1.?) and Issues (until V1.?).
* Assisted other students in Slack and Forums (Issue ).
